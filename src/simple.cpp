...
int main(int argc, char **argv) {
  ...
  if (dyn_elf.is_dynamic) {
    ...
    static const std::vector<std::string> allowed_readable_paths({
        ...
        // libcap
        "/lib64/libcap.so.2",
        "/lib64/glibc-hwcaps/x86-64-v2/libcap.so.2",
        "/lib64/glibc-hwcaps/x86-64-v3/libcap.so.2",
        "/lib64/glibc-hwcaps/x86-64-v4/libcap.so.2",

        // libpcre
        "/lib64/libpcre2-8.so.0",
        "/lib64/glibc-hwcaps/x86-64-v2/libpcre2-8.so.0",
        "/lib64/glibc-hwcaps/x86-64-v3/libpcre2-8.so.0",
        "/lib64/glibc-hwcaps/x86-64-v4/libpcre2-8.so.0",

        // libacl
        "/lib64/libacl.so.1",
        "/lib64/glibc-hwcaps/x86-64-v2/libacl.so.1",
        "/lib64/glibc-hwcaps/x86-64-v3/libacl.so.1",
        "/lib64/glibc-hwcaps/x86-64-v4/libacl.so.1",
